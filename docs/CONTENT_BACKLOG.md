...
| Ejercicios (todos los tipos) | Cientos, por skill | 🟡 22 ejercicios reales (HTML 5, CSS 5, JavaScript 7, Git 5) cubriendo los 7 tipos con motor de corrección propio: MCQ, TRUE_FALSE, ORDERING, MATCHING, OUTPUT_PREDICTION, CODE_COMPLETION, DEBUGGING. CODE_WRITING/SQL/TERMINAL/REAL_CASE/PROJECT_TASK existen en el esquema pero su corrección depende del exec-service (Fase 5) o de módulos posteriores (Fase 6/7) — no se siembran ejercicios de esos tipos todavía para no presentar contenido a medio funcionar |
