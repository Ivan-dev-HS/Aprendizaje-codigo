...
| GET            | `/interviews`                          | Plantillas de entrevista (filtrable por category)                                                         | 8    |
| GET            | `/interviews/:slug`                    | Detalle de una plantilla (preguntas sin expectedAnswer/concepts)                                          | 8    |
| POST           | `/interviews/:id/start`                | Inicia (o reanuda, idempotente) un intento                                                                | 8    |
