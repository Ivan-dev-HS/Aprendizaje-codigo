    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="animate-dropdown-in absolute right-0 z-20 mt-2 w-80 rounded-xl border border-slate-200 bg-white shadow-lg dark:border-slate-800 dark:bg-slate-900">
